...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{ url('/') }}" class="brand-link">
        ...
        <span class="brand-text font-weight-light">TIL_Accessories</span>
    </a>
            ...
            <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent" data-widget="treeview" role="menu">
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                            ...
                            @endcan
                            @can('view-any', App\Models\ItemUmo::class)
                            <li class="nav-item">
                                <a href="{{ route('item-umos.index') }}" class="nav-link">
                                    <i class="nav-icon icon ion-md-radio-button-off"></i>
                                    <p>Item Umos</p>
                                </a>
                            </li>
                            @endcan
                            @can('view-any', App\Models\TilAccessories::class)
                            <li class="nav-item">
                                <a href="{{ route('til-accessories.index') }}" class="nav-link">
                                    <i class="nav-icon icon ion-md-radio-button-off"></i>
                                    <p>Til Accessories List</p>
                                </a>
                            </li>
                            @endcan
                    </ul>
