...
class ItemTilAccessoriesTest extends TestCase
{
     ...
     * @test
     */
    public function it_gets_item_til_accessories(): void
    {
        ...
        $response = $this->getJson(
            route('api.items.til-accessories.index', $item)
        );
     ...
     * @test
     */
    public function it_stores_the_item_til_accessories(): void
    {
        $item = Item::factory()->create();
        ...
        $response = $this->postJson(
            route('api.items.til-accessories.store', $item),
            $data
        );
