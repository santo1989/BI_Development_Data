...
class ItemAllTilAccessoriesController extends Controller
{
    ...
    public function store(Request $request, Item $item): TilAccessoriesResource
    {
        ...
        $tilAccessories = $item->allTilAccessories()->create($validated);
